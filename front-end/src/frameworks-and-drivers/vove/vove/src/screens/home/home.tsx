  ...
  return (<ScrollView style={{backgroundColor: Color.white_100}}>
    <View style={styles.container}>
      <View style={{alignItems: "flex-start", width: ScreenSize.width * 0.9}}>
        <Text style={{...TextStyle.h3, color: Color.primary_100}}>HCMC Mosquito Distribution</Text>
      </View>
      ...
      >
        ...
        <View style={{flexDirection: "row", width: "95%", justifyContent: "space-between"}}>
          <View
            ...
            <Text style={{...TextStyle.bodyLarge, color: "white"}}>WeWork E. Town Central</Text>
            <Text style={{...TextStyle.bodySmall, color: "white"}}>11 Đoàn Văn Bơ, Phường 12, Quận 4</Text>
          </View>
          <Pressable style={{
            height: ScreenSize.width * 0.17,
      ...
      <View style={{alignItems: "flex-start", width: ScreenSize.width * 0.9}}>
        <Text style={{...TextStyle.h3, color: Color.primary_100}}>HCMC Overview</Text>
      </View>
      <View style={styles.hcmcSummaryContainer}>
        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
          <Text style={{...TextStyle.bodyLarge, color: Color.primary_20}}>Normal</Text>
          <Text style={{...TextStyle.bodyLarge, color: Color.primary_20}}>19</Text>
        </View>
        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
          <Text style={{...TextStyle.bodyLarge, color: Color.yellow_20}}>Low risk</Text>
          <Text style={{...TextStyle.bodyLarge, color: Color.yellow_20}}>1</Text>
        </View>
        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
          <Text style={{...TextStyle.bodyLarge, color: Color.orange_20}}>High risk</Text>
          <Text style={{...TextStyle.bodyLarge, color: Color.orange_20}}>1</Text>
        </View>
        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
          <Text style={{...TextStyle.bodyLarge, color: Color.red_100}}>Epidemic</Text>
          <Text style={{...TextStyle.bodyLarge, color: Color.red_100}}>1</Text>
        </View>
      </View>
      <View style={{height: ScreenSize.width * 0.03}}>
      </View>
      <ButtonFullWidth
