    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.center}>
          <InputInformation
            title="Time"
            information={inquiryDetail.timestamp}
            width="100%"
          ></InputInformation>
          <InputInformation
            title="Status"
            information={inquiryStatus}
            width="100%"
          ></InputInformation>
          <InputInformation
            title="Addess"
            information={inquiryDetail.address}
            width="100%"
          ></InputInformation>
          <InputInformation
            title="Message"
            information={inquiryDetail.content}
            width="100%"
          ></InputInformation>
        ...
        {inquiryDetail.comments.length !== 0 ? (
          <View>
            <Text style={{ ...TextStyle.h3, color: Color.dark_100 }}>
              Comments ({inquiryDetail.comments.length})
            </Text>
      ...
      >
        <ButtonHalfWidth
          type={
            inquiryDetail.status !== InquiryStatusType.CLOSED
              ? ButtonType.DEFAULT
              : ButtonType.DISABLE
          }
          content={'New Comment'}
