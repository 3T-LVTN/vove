        ...
        <View style={{alignItems: "center", paddingVertical: ScreenSize.height * 0.15}}>
          <View style={{alignItems: "center",}}>
            <Image
              ...
              style={{width: ScreenSize.width * 0.67, height: ScreenSize.width * 0.6}}
            ></Image>
          </View>
          <InputText
            title={"Phone number"}
          ...
          <View style={{
            ...
            <View style={{flex: 1, flexDirection: 'row'}}>
              <Text style={{...TextStyle.h3, color: Color.grey_100}}>Remember me </Text>
            </View>
            <View style={{flex: 1, alignItems: 'flex-end'}}>
              <Pressable onPress={() => props.navigation.navigate("ForgetPasswordStack")}>
                <Text style={{...TextStyle.h3, color: Color.primary_100}}>Forgot password?</Text>
              </Pressable>
            </View>
          </View>
