    ...
    <View style={styles.container}>
      <ScrollView style={{paddingTop: 12, backgroundColor: Color.white_100,}} showsVerticalScrollIndicator={false}
        ...
        <View style={styles.center}>
          <Text style={{...TextStyle.h3, color: Color.dark_100, alignSelf: "flex-start"}}>Title</Text>
          <View style={{paddingTop: ScreenSize.width * 0.02}}/>
          <View style={{...styles.contentInput, height: ScreenSize.height * 0.06}}></View>
          <View style={{paddingTop: ScreenSize.width * 0.02}}/>
          <Text style={{...TextStyle.h3, color: Color.dark_100, alignSelf: "flex-start"}}>Message</Text>
          <View style={{paddingTop: ScreenSize.width * 0.02}}/>
          <View style={{...styles.contentInput, height: ScreenSize.height * 0.5}}></View>
          {/*<InputText*/}
          {/*  title={'Title'}*/}
