...
export function PlaceDetail(props: PlaceDetailProps) {
  ...
  const placeStatus: string = placeDetail.status === TrackingPlaceStatusType.GOOD ? "GOOD" : placeDetail.status === TrackingPlaceStatusType.LOW_RISK ? "LOW RISK" : placeDetail.status === TrackingPlaceStatusType.HIGH_RISK ? "HIGH RISK" : "EPIDEMIC";
  return (
    <ScrollView style={{height: ScreenSize.height, backgroundColor: "white"}} showsVerticalScrollIndicator={false}
      ...
      <View style={styles.container}>
        ...
        <View style={styles.containerWithBorder}>
          ...
          }}>How correct is this prediction?</Text>
          <View style={{flexDirection: "row", width: "100%", justifyContent: "space-between", paddingTop: 10}}>
            <Pressable style={styles.optionExact}><Text style={{...TextStyle.h3, color: "white"}}>Exactly</Text></Pressable>
            <Pressable style={styles.optionNormal}><Text style={{...TextStyle.h3, color: "white"}}>Normal</Text></Pressable>
            <Pressable style={styles.optionFalse}><Text style={{...TextStyle.h3, color: "white"}}>False</Text></Pressable>
          </View>
        </View>
        <View style={{width: "100%", paddingVertical: ScreenSize.height * 0.02}}>
          <Text style={{...TextStyle.h3, color: Color.primary_100}}>What should you do</Text>
          <View style={styles.containerWithBorder}>
