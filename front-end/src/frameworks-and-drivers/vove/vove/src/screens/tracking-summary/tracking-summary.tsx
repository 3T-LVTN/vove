  ...
  return (
    <View style={styles.container}>
      <View style={styles.center}>
        ...
        <TrackingSummaryCard
          placeName={myArea.placeName}
          address={myArea.address}
          status={myArea.status}
          notificationAllowed={myArea.notificationAllowed}
        ...
        {trackingSummaryList.map((trackingPlace) => (
          <TrackingSummaryCard
            placeName={trackingPlace.placeName}
            address={trackingPlace.address}
            status={trackingPlace.status}
            notificationAllowed={trackingPlace.notificationAllowed}
            navigation={props.navigation}
            placeDetail={trackingPlace}
          />
        ))}
      </View>
      <ButtonFullWidth
        content={'All Saved Places'}
